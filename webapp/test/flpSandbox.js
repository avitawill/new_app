		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Tile app insight",
									"targetURL": "#insightzaptiles-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"insightzaptiles-display": {
								"semanticObject": "insightzaptiles",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=insightzaptiles",
									"url": sap.ui.require.toUrl("insightzaptiles")
								}
							}
						}
					}
